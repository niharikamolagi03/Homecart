...
import {
  ShoppingBag, Store, Truck, Shield, Users, ArrowRight,
  CheckCircle, Sparkles, Award, Clock,
  ShieldCheck, Crown, Gift, Rocket,
      ...
      <section className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            ...
            <p className="text-2xl sm:text-3xl font-semibold text-gray-800 mb-4 max-w-3xl mx-auto">
              Where every purchase meets a dream 💫
            </p>
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Connect, Shop, Sell, and Deliver with ease
            </p>
              ...
              <Link to="/register">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button size="lg" variant="outline" className="text-lg px-8 py-6 border-2 border-blue-600 text-blue-600 hover:bg-blue-50">
                    Create Account <Users className="w-5 h-5 ml-2" />
                  </Button>
                </motion.div>
              </Link>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Powerful features designed for every user type</p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Become part of something extraordinary</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -8 }}
                className="bg-white rounded-2xl p-8 shadow-xl text-center group"
              >
          ...
          >
            ...
            <div className="relative z-10 p-12 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Join Our Happy Members</h2>
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Be part of India's fastest growing marketplace community.
              </p>
              <Link to="/roles">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="inline-block">
                  <Button size="lg" className="bg-white text-purple-600 text-lg px-8 py-6 shadow-xl hover:shadow-2xl font-semibold">
                    Join Now <Users className="w-5 h-5 ml-2" />
                  </Button>
                </motion.div>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li className="flex items-center gap-2"><MapPinIcon className="w-4 h-4" /> Bangalore, India</li>
              </ul>
            </div>
          </div>
